...
\acmConference[WebSci'2025]{17th ACM Web Science Conference 2025}{May 20--24,
  2025}{New Brunswick, NJ, USA}
...
%% \title{Analysis of Communities formed in YouTube Comment Sections \humberto{Analyzing Communities in YouTube Comment Sections??? Seria Analyzing ou Identifying? ou ambos?}}
...
%% article.
\begin{abstract}
% \humberto{Como é um processo double-blind review, omiti nossos nomes.}
    ...
    % \humberto{Seria legal colocar aqui uma ou duas frases com os principals resultados.}
\end{abstract}
...
% \humberto{Seria bom tentar melhorar o equilíbrio visual dessa figura.Sugiro colocar objetos similares com o mesmo tamanho, evitar quebras de seta e setas misturadas.}
% \humberto{COMENTÁRIO GERAL: não use voz passive. Em textos técnicos escritos em inglês você pode usar a primeira pessoa do plural (WE).}
