...
\subsection{Timeline}
% Sobre o cronograma, você precisa planejar o que vai fazer no segundo segundo semestre. 
% Comece de trás para frente por uma data de apresentação do TCC no final do semestre. 
% Aí você coloca quanto tempo precisa para finalizar a escrita do TCC um mês antes da apresentação, uma vez que preciso revisar. 
% Em seguida, ainda de trás para frente, coloque as tarefas com o respectivo tempo de execução que ainda faltam!


\begin{ganttchart}[
    hgrid,
    vgrid,
    x unit=1.2cm, % Adjust the unit size
    y unit title=0.8cm,
    y unit chart=0.5cm,
    title height=1,
    title label anchor/.style={below=-1.6ex},
    bar/.append style={fill=blue!30},
    group/.append style={fill=blue!60, draw=blue}, % Change group color to blue
    group right shift=0,
    group top shift=0.6,
    group height=.3,
    bar height=.5,
    milestone height=.5,
    milestone top shift=.6,
    milestone label font=\tiny\color{black!50},
    bar label font=\scriptsize\color{black!50},
    group label font=\scriptsize\color{black!50},
    link/.style={-latex, red}
]{1}{7}
    \gantttitle{Months (June to December)}{7} \\
    \gantttitlelist{6,7,8,9,10,11,12}{1} \\

    % Data Collection and Analysis
    \ganttgroup{Data Collection \& Analysis}{1}{3} \\
    \ganttbar{Collect Data}{1}{2} \\
    \ganttbar{Clean Data}{2}{3} \\

    % Data Collection and Analysis
    \ganttgroup{Building the Model \& Comparing the Results}{3}{5} \\
    \ganttbar{Apply UPFD Framework}{3}{3} \\
    \ganttbar{UPFD Framework for Early Detection}{3}{5} \\
    \ganttbar{Result analysis}{4}{5} \\

    % Writing the Thesis
    \ganttgroup{Finalizing the written document}{5}{7} \\
    \ganttbar{Result analysis}{5}{7} \\
    \ganttbar{Fix written errors}{5}{6} \\
    \ganttbar{Review}{6}{7} \\

    % Final Submission
    \ganttgroup{Final Submission}{7}{7} \\
    \ganttbar{Review Final Document}{7}{7} \\
    \ganttbar{Submit Thesis}{7}{7} \\
\end{ganttchart}
